...
| [`openai-compatible-imagegen`](skills/openai-compatible-imagegen/SKILL.md) | An image should be generated or edited through a user-configured OpenAI-compatible Images API. | Uses an API key and base URL to run a local, traceable image-generation command without bundling Listing strategy or publishing. |
